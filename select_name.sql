...
SELECT institution, ROUND(AVG(score*response)/AVG(response)) FROM nss
WHERE question='Q22'
...
FROM ge
WHERE constituency = 'StopA4000024' AND yr = 2017
ORDER BY votes DESC
...
FROM ge
WHERE constituency = 'StopA4000021'
ORDER BY party,yr

SELECT constituency,party, votes,
RANK() OVER (PARTITION BY constituency ORDER BY votes DESC) as posn
FROM ge
WHERE constituency BETWEEN 'StopA4000021' AND 'StopA4000026'
AND yr = '2017'
